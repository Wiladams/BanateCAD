...
function Texture:_init(filename)
	-- load the bitmap
...
function Texture.loadPixels(self)
...
function Texture.updatePixels(self)
...
function Texture.set(self, x, y, acolor)
	if self.pixels == nil then
		return
	end
